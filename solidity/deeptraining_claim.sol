...
// File: GAEA_deeptraining_claim.sol
...
contract ClaimAward is WhiteList{
    ...
    // Whitelisted admin: Transfer tokens
    function transferToken(address _token, address _recipient, uint256 _amount) public isWhiteListed{
